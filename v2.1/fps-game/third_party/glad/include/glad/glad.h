...
GLAPI extern struct gladGLversionStruct GLVersion;
GLAPI extern int gladExtensions[1];
...
// Function pointers
#define GLAD_FUNCTION_POINTER(type, name) type name;
#include "glad_func_ptrs.h"
